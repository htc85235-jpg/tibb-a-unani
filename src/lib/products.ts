/* DUMMY product catalog — replace names, prices, images & details with the
   client's real products when provided. All copy is original placeholder text. */
...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Majoon Jograj Guggul",
    urdu: "مجون جوگراج گگل",
    category: "Majoon",
    size: "200 g",
    price: 1950,
    compareAt: 2400,
    img: "/images/p_powder.png",
    rating: 4.6,
    reviews: 176,
    sold24: 12,
    viewing: 9,
    ...
    pairWith: ["roghan-babchi", "habbe-bawasir"],
  },
  {
    slug: "khamira-gilo-himalayi",
    name: "Khamira Gilo Himalayi",
    urdu: "خمیرہ گیلاو ہمالیائی",
    category: "Khamira",
    size: "150 g",
    price: 2800,
    compareAt: 3400,
  ...
  },
  {
    ...
    name: "Roghan Baadam Shirin",
    urdu: "روغن بادام شیرین",
    category: "Roghan",
    size: "100 ml",
    price: 1200,
    img: "/images/p_oil.png",
  ...
  },
  {
    ...
    pairWith: ["majoon-e-shahi", "habbe-bawasir"],
  },
  {
    slug: "habbe-bawasir",
    name: "Habbe Bawasir",
    ...
    inStock: false,
    fresh: false,
    short: "Time-tested herbal pills for piles comfort — traditionally used for bleeding and non-bleeding piles.",
    description: [
      "Habbe Bawasir combines astringent and cooling herbs in the classical pill form used for generations against the burning and discomfort of piles.",
      "It works from within, supporting healthy digestion and comfortable routine. Currently out of stock — new batch in preparation.",
    ],
    benefits: [
      "Traditional comfort for piles symptoms",
      "Supports healthy digestion from within",
      "Cooling, astringent herbal formula",
      "Restocks regularly",
    ],
    dosage: "One pill morning and evening with water, or as directed by your Hakeem.",
    pairWith: ["habbe-mumsik", "majoon-jograj-guggul"],
  },
  {
    slug: "bone-joint-capsules",
    name: "Bone & Joint Care Capsules",
    urdu: "کمیون کیپسول",
    category: "Capsule",
    size: "60 capsules",
    price: 1850,
    compareAt: 2200,
    img: "/images/p_caps.png",
    rating: 4.7,
    reviews: 203,
    sold24: 25,
    viewing: 14,
    inStock: true,
    fresh: true,
    short: "Easy-to-take herbal capsules with classical joint herbs — modern convenience, traditional wisdom.",
    description: [
      "For those who find classical majoons difficult, our joint care capsules pack the same respected herbs — purified guggul, shallaki-like botanicals and warming digestives — into clean vegetarian capsules.",
      "Two capsules a day is all it takes to keep the classical joint routine going, at home or while travelling.",
    ],
    benefits: [
      "Classical joint herbs in capsule form",
      "Convenient twice-daily routine",
      "Vegetarian capsule shell",
      "Lab tested for purity",
    ],
    dosage: "One capsule after breakfast and dinner with lukewarm water, or as directed by your Hakeem.",
    pairWith: ["majoon-jograj-guggul", "roghan-babchi"],
  },
];
